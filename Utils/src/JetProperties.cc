...
DEFAULT_NAMED_PTR(bDiscriminator,pfDeepBoostedDiscriminatorsJetTagsZHbbvsQCD);
DEFAULT_NAMED_PTR(bDiscriminator,pfDeepBoostedDiscriminatorsJetTagsZbbvsQCD);
DEFAULT_NAMED_PTR(bDiscriminator,pfDeepBoostedDiscriminatorsJetTagsbbvsLight);
