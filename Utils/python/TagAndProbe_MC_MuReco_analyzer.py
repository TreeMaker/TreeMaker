...
InputFileName = "/afs/desy.de/user/a/adraeger/2015/TagAndProbe/muReco/TagAndProbeEff_MuReco.root"
...
#HT = cms.vdouble(0, 4000 ),
#NJets = cms.vdouble( 3,20 ), 
Pt = cms.vdouble(0,2000),
Activity = cms.vdouble(0,3600),
)
## for super clusters
