...
class MCSampleHelper():
    ...
    __xs_dict = {
        ...
        "TTTo2L2Nu"                                                      : XSValues(-1.0, -1.0, 88.29,        -1.0),
        "TTToHadronic"                                                   : XSValues(-1.0, -1.0, 377.96,       -1.0),
        "TTToSemiLeptonic"                                               : XSValues(-1.0, -1.0, 365.34  ,     -1.0),
        ...
        "QCD_Pt-50to80_MuEnrichedPt5"                                    : XSValues(-1.0, -1.0, 376600.0,     -1.0),
        "QCD_Pt-80to120_MuEnrichedPt5"                                   : XSValues(-1.0, -1.0, 88930.0,      -1.0),
        "QCD_Pt-120to170_MuEnrichedPt5"                                  : XSValues(-1.0, -1.0, 21230.0,      -1.0),
        ...
        "TTTJ"                                                           : XSValues(-1.0, -1.0, 0.0004812,    -1.0),
        "WWW_4F"                                                         : XSValues(-1.0, -1.0, 0.2086,       -1.0),
        "WWZ_4F"                                                         : XSValues(-1.0, -1.0, 0.1651,       -1.0),
        "WWZ"                                                            : XSValues(-1.0, -1.0, 0.1651,       -1.0),
        "WZZ"                                                            : XSValues(-1.0, -1.0, 0.05565,      -1.0),
        "ZZZ"                                                            : XSValues(-1.0, -1.0, 0.01398,      -1.0),
        "SMS-T1bbbb_mGluino-1000_mLSP-900"                               : XSValues(-1.0, -1.0, 0.385E+00,    -1.0),
        "SMS-T1bbbb_mGluino-1500_mLSP-100"                               : XSValues(-1.0, -1.0, 0.157E-01,    -1.0),
        "SMS-T1tttt_mGluino-1200_mLSP-800"                               : XSValues(-1.0, -1.0, 0.985E-01,    -1.0),
        "SMS-T1tttt_mGluino-1500_mLSP-100"                               : XSValues(-1.0, -1.0, 0.157E-01,    -1.0),
        "SMS-T1tttt_mGl-1500_mLSP-100"                                   : XSValues(-1.0, -1.0, 0.157E-01,    -1.0),
        "SMS-T1tttt_mGluino-2000_mLSP-100"                               : XSValues(-1.0, -1.0, 0.101E-02,    -1.0),
        "SMS-T1qqqq_mGluino-1000_mLSP-800"                               : XSValues(-1.0, -1.0, 0.385E+00,    -1.0),
        "SMS-T1qqqq_mGluino-1400_mLSP-100"                               : XSValues(-1.0, -1.0, 0.284E-01,    -1.0),
        "SMS-T1qqqq_mGluino-1800_mLSP-200_ctau-1"                        : XSValues(-1.0, -1.0, 0.293E-02,    -1.0),
        "SMS-T2tt_mStop-150_mLSP-50"                                     : XSValues(-1.0, -1.0, 0.304E+03,    -1.0),
        "SMS-T2tt_mStop-200_mLSP-50"                                     : XSValues(-1.0, -1.0, 0.755E+02,    -1.0),
        "SMS-T2tt_mStop-225_mLSP-50"                                     : XSValues(-1.0, -1.0, 0.420E+02,    -1.0),
        "SMS-T2tt_mStop-250_mLSP-150"                                    : XSValues(-1.0, -1.0, 0.248E+02,    -1.0),
        "SMS-T2tt_mStop-250_mLSP-50"                                     : XSValues(-1.0, -1.0, 0.248E+02,    -1.0),
        "SMS-T2tt_mStop-300_mLSP-150"                                    : XSValues(-1.0, -1.0, 0.100E+02,    -1.0),
        "SMS-T2tt_mStop-325_mLSP-150"                                    : XSValues(-1.0, -1.0, 0.657E+01,    -1.0),
        "SMS-T2tt_mStop-350_mLSP-150"                                    : XSValues(-1.0, -1.0, 0.443E+01,    -1.0),
        "SMS-T2tt_mStop-425_mLSP-325"                                    : XSValues(-1.0, -1.0, 0.154E+01,    -1.0),
        "SMS-T2tt_mStop-500_mLSP-325"                                    : XSValues(-1.0, -1.0, 0.609E+00,    -1.0),
        "SMS-T2tt_mStop-650_mLSP-350"                                    : XSValues(-1.0, -1.0, 0.125E+00,    -1.0),
        "SMS-T2tt_mStop-850_mLSP-100"                                    : XSValues(-1.0, -1.0, 0.216E-01,    -1.0),
        "SMS-T2tt_mStop-1200_mLSP-100"                                   : XSValues(-1.0, -1.0, 0.170E-02,    -1.0),
        "SMS-T5qqqqWW_mGluino-1900_mLSP-100"                             : XSValues(-1.0, -1.0, 0.171E-02,    -1.0),
        "SMS-T5qqqqZH-mGluino750"                                        : XSValues(-1.0, -1.0, 0.277E+01,    -1.0),
        "SMS-T5qqqqZH-mGluino1000"                                       : XSValues(-1.0, -1.0, 0.385E+00,    -1.0),
        "SMS-T5qqqqZH-mGluino1100"                                       : XSValues(-1.0, -1.0, 0.191E+00,    -1.0),
        "SMS-T5qqqqZH-mGluino1200"                                       : XSValues(-1.0, -1.0, 0.985E-01,    -1.0),
        "SMS-T5qqqqZH-mGluino1300"                                       : XSValues(-1.0, -1.0, 0.522E-01,    -1.0),
        "SMS-T5qqqqZH-mGluino1400"                                       : XSValues(-1.0, -1.0, 0.284E-01,    -1.0),
        "SMS-T5qqqqZH-mGluino1500"                                       : XSValues(-1.0, -1.0, 0.157E-01,    -1.0),
        "SMS-T5qqqqZH-mGluino1600"                                       : XSValues(-1.0, -1.0, 0.887E-02,    -1.0),
        "SMS-T5qqqqZH-mGluino1700"                                       : XSValues(-1.0, -1.0, 0.507E-02,    -1.0),
        "SMS-T5qqqqZH-mGluino1800"                                       : XSValues(-1.0, -1.0, 0.293E-02,    -1.0),
        "SMS-T5qqqqZH-mGluino1900"                                       : XSValues(-1.0, -1.0, 0.171E-02,    -1.0),
        "SMS-T5qqqqZH-mGluino2000"                                       : XSValues(-1.0, -1.0, 0.101E-02,    -1.0),
        "SMS-T5qqqqZH-mGluino2100"                                       : XSValues(-1.0, -1.0, 0.598E-03,    -1.0),
        "SMS-T5qqqqZH-mGluino2200"                                       : XSValues(-1.0, -1.0, 0.321E-03,    -1.0),
        ...
        "StealthSHH_2t4b_mStop-450_mSo-100"                              : XSValues(-1.0, -1.0, 0.948333,     -1.0),
        "StealthSHH_2t4b_mStop-500_mSo-100"                              : XSValues(-1.0, -1.0, 0.51848,      -1.0),
        "StealthSHH_2t4b_mStop-550_mSo-100"                              : XSValues(-1.0, -1.0, 0.296128,     -1.0),
        "StealthSHH_2t4b_mStop-600_mSo-100"                              : XSValues(-1.0, -1.0, 0.174599,     -1.0),
        "StealthSHH_2t4b_mStop-650_mSo-100"                              : XSValues(-1.0, -1.0, 0.107045,     -1.0),
        "StealthSHH_2t4b_mStop-700_mSo-100"                              : XSValues(-1.0, -1.0, 0.0670476,    -1.0),
        "StealthSHH_2t4b_mStop-750_mSo-100"                              : XSValues(-1.0, -1.0, 0.0431418,    -1.0),
        "StealthSHH_2t4b_mStop-800_mSo-100"                              : XSValues(-1.0, -1.0, 0.0283338,    -1.0),
        "StealthSHH_2t4b_mStop-850_mSo-100"                              : XSValues(-1.0, -1.0, 0.0189612,    -1.0),
        "StealthSHH_2t4b_mStop-900_mSo-100"                              : XSValues(-1.0, -1.0, 0.0128895,    -1.0),
        ...
        "RPV_2t6j_mStop-300_mN1-100"                                     : XSValues(-1.0, -1.0, 8.51615,      -1.0),
        "RPV_2t6j_mStop-350_mN1-100"                                     : XSValues(-1.0, -1.0, 3.78661,      -1.0),
        "RPV_2t6j_mStop-400_mN1-100"                                     : XSValues(-1.0, -1.0, 1.83537,      -1.0),
        "RPV_2t6j_mStop-450_mN1-100"                                     : XSValues(-1.0, -1.0, 0.948333,     -1.0),
        "RPV_2t6j_mStop-500_mN1-100"                                     : XSValues(-1.0, -1.0, 0.51848,      -1.0),
        "RPV_2t6j_mStop-550_mN1-100"                                     : XSValues(-1.0, -1.0, 0.296128,     -1.0),
        "RPV_2t6j_mStop-600_mN1-100"                                     : XSValues(-1.0, -1.0, 0.174599,     -1.0),
        "RPV_2t6j_mStop-650_mN1-100"                                     : XSValues(-1.0, -1.0, 0.107045,     -1.0),
        "RPV_2t6j_mStop-700_mN1-100"                                     : XSValues(-1.0, -1.0, 0.0670476,    -1.0),
        "RPV_2t6j_mStop-750_mN1-100"                                     : XSValues(-1.0, -1.0, 0.0431418,    -1.0),
        "RPV_2t6j_mStop-800_mN1-100"                                     : XSValues(-1.0, -1.0, 0.0283338,    -1.0),
        "RPV_2t6j_mStop-850_mN1-100"                                     : XSValues(-1.0, -1.0, 0.0189612,    -1.0),
        "RPV_2t6j_mStop-900_mN1-100"                                     : XSValues(-1.0, -1.0, 0.0128895,    -1.0),
    }
