...
class MCSampleValuesHelper():
	...
	XSValues = namedtuple_with_defaults('XSValues', __xs_field_names, [-1.0,""]*len(__years))
	kFactorValues = namedtuple_with_defaults('kFactorValues', __kfactor_field_names, [1.0,""]*len(__years))


	__values_dict = {
		"TT"												: {
			"CrossSection" : XSValues(XS_2016=831.76), 
		},
		"TTJets"											: {
			"CrossSection" : XSValues(XS_2016=831.76),
		},
		...
		"TTJets_SingleLeptFromT"							: {
			"CrossSection" : XSValues(XS_2016=182.72),
		},
		"TTJets_SingleLeptFromTbar"							: {
			"CrossSection" : XSValues(XS_2016=182.72),
		},
		"TTJets_DiLept"										: {
			"CrossSection" : XSValues(XS_2016=88.34),
		},
		...
		"ST_s-channel_4f_leptonDecays"						: {
			"CrossSection" : XSValues(XS_2016=3.34),
		},
		"ST_s-channel_4f_InclusiveDecays"					: {
			"CrossSection" : XSValues(XS_2016=10.32),
		},
		"ST_t-channel_top_4f_inclusiveDecays"				: {
			"CrossSection" : XSValues(XS_2016=136.02),
		},
		"ST_t-channel_antitop_4f_inclusiveDecays"			: {
			"CrossSection" : XSValues(XS_2016=80.95),
		},
		"ST_tW_antitop_5f_NoFullyHadronicDecays"			: {
			"CrossSection" : XSValues(XS_2016=19.4674),
		},
		"ST_tW_top_5f_NoFullyHadronicDecays"				: {
			"CrossSection" : XSValues(XS_2016=19.4674),
		},
		"ST_tW_antitop_5f_inclusiveDecays"					: {
			"CrossSection" : XSValues(XS_2016=35.6),
		},
		...
		"SMS-T1bbbb_mGluino-1000_mLSP-900"					: {
			"CrossSection" : XSValues(XS_2016=0.385E+00),
		},
		"SMS-T1bbbb_mGluino-1500_mLSP-100"					: {
			"CrossSection" : XSValues(XS_2016=0.157E-01),
		},
		"SMS-T1tttt_mGluino-1200_mLSP-800"					: {
			"CrossSection" : XSValues(XS_2016=0.985E-01),
		},
		...
		"SMS-T1tttt_mGluino-2000_mLSP-100"					: {
			"CrossSection" : XSValues(XS_2016=0.101E-02),
		},
		"SMS-T1qqqq_mGluino-1000_mLSP-800"					: {
			"CrossSection" : XSValues(XS_2016=0.385E+00),
		},
		"SMS-T1qqqq_mGluino-1400_mLSP-100"					: {
			"CrossSection" : XSValues(XS_2016=0.284E-01),
		},
		"SMS-T1qqqq_mGluino-1800_mLSP-200_ctau-1"			: {
			"CrossSection" : XSValues(XS_2016=0.293E-02),
		},
		"SMS-T2tt_mStop-150_mLSP-50"						: {
			"CrossSection" : XSValues(XS_2016=0.304E+03),
		},
		"SMS-T2tt_mStop-200_mLSP-50"						: {
			"CrossSection" : XSValues(XS_2016=0.755E+02),
		},
		"SMS-T2tt_mStop-225_mLSP-50"						: {
			"CrossSection" : XSValues(XS_2016=0.420E+02),
		},
		"SMS-T2tt_mStop-250_mLSP-150"						: {
			"CrossSection" : XSValues(XS_2016=0.248E+02),
		},
		"SMS-T2tt_mStop-250_mLSP-50"						: {
			"CrossSection" : XSValues(XS_2016=0.248E+02),
		},
		"SMS-T2tt_mStop-300_mLSP-150"						: {
			"CrossSection" : XSValues(XS_2016=0.100E+02),
		},
		"SMS-T2tt_mStop-325_mLSP-150"						: {
			"CrossSection" : XSValues(XS_2016=0.657E+01),
		},
		"SMS-T2tt_mStop-350_mLSP-150"						: {
			"CrossSection" : XSValues(XS_2016=0.443E+01),
		},
		"SMS-T2tt_mStop-425_mLSP-325"						: {
			"CrossSection" : XSValues(XS_2016=0.154E+01),
		},
		"SMS-T2tt_mStop-500_mLSP-325"						: {
			"CrossSection" : XSValues(XS_2016=0.609E+00),
		},
		"SMS-T2tt_mStop-650_mLSP-350"						: {
			"CrossSection" : XSValues(XS_2016=0.125E+00),
		},
		"SMS-T2tt_mStop-850_mLSP-100"						: {
			"CrossSection" : XSValues(XS_2016=0.216E-01),
		},
		"SMS-T2tt_mStop-1200_mLSP-100"						: {
			"CrossSection" : XSValues(XS_2016=0.170E-02),
		},
		"SMS-T5qqqqWW_mGluino-1900_mLSP-100"				: {
			"CrossSection" : XSValues(XS_2016=0.171E-02),
		},
		"SMS-T5qqqqZH-mGluino750"							: {
			"CrossSection" : XSValues(XS_2016=0.277E+01),
		},
		"SMS-T5qqqqZH-mGluino1000"							: {
			"CrossSection" : XSValues(XS_2016=0.385E+00),
		},
		"SMS-T5qqqqZH-mGluino1100"							: {
			"CrossSection" : XSValues(XS_2016=0.191E+00),
		},
		"SMS-T5qqqqZH-mGluino1200"							: {
			"CrossSection" : XSValues(XS_2016=0.985E-01),
		},
		"SMS-T5qqqqZH-mGluino1300"							: {
			"CrossSection" : XSValues(XS_2016=0.522E-01),
		},
		...
		"SMS-T5qqqqZH-mGluino1600"							: {
			"CrossSection" : XSValues(XS_2016=0.887E-02),
		},
		"SMS-T5qqqqZH-mGluino1700"							: {
			"CrossSection" : XSValues(XS_2016=0.507E-02),
		},
		...
		"SMS-T5qqqqZH-mGluino2100"							: {
			"CrossSection" : XSValues(XS_2016=0.598E-03),
		},
		"SMS-T5qqqqZH-mGluino2200"							: {
			"CrossSection" : XSValues(XS_2016=0.321E-03),
		},
		"SMS_TChiWH_WToLNu_HToBB_mChargino850_mLSP1"		: {
			"CrossSection" : XSValues(XS_2016=0.002548),
		},
		"SMS-TChiWZ_ZToLL_mZMin-0p1_mChargino250_mLSP230"	: {
			"CrossSection" : XSValues(XS_2016=0.6204),
		},
		"SMS-TChiWZ_ZToLL_mZMin-0p1"						: {
			"CrossSection" : XSValues(XS_2016=0.6204),
		},
		"stealth_stop_350_singlino_SYY"						: {
			"CrossSection" : XSValues(XS_2016=3.78661),
		},
		"stealth_stop_450_singlino_SYY"						: {
			"CrossSection" : XSValues(XS_2016=0.948333),
		},
		"stealth_stop_550_singlino_SYY"						: {
			"CrossSection" : XSValues(XS_2016=0.296128),
		},
		"stealth_stop_650_singlino_SYY"						: {
			"CrossSection" : XSValues(XS_2016=0.107045),
		},
		"stealth_stop_750_singlino_SYY"						: {
			"CrossSection" : XSValues(XS_2016=0.0431418),
		},
		"stealth_stop_850_singlino_SYY"						: {
			"CrossSection" : XSValues(XS_2016=0.0189612),
		},
		...
		"StealthSYY_2t6j_mStop-300_mSo-100"					: {
			"CrossSection" : XSValues(XS_2016=8.51615),
		},
		...
		"StealthSYY_2t6j_mStop-400_mSo-100"					: {
			"CrossSection" : XSValues(XS_2016=1.83537),
		},
		...
		"StealthSYY_2t6j_mStop-500_mSo-100"					: {
			"CrossSection" : XSValues(XS_2016=0.51848),
		},
		...
		"StealthSYY_2t6j_mStop-600_mSo-100"					: {
			"CrossSection" : XSValues(XS_2016=0.174599),
		},
		...
		"StealthSYY_2t6j_mStop-700_mSo-100"					: {
			"CrossSection" : XSValues(XS_2016=0.0670476),
		},
		...
		"StealthSYY_2t6j_mStop-800_mSo-100"					: {
			"CrossSection" : XSValues(XS_2016=0.0283338),
		},
		...
		"StealthSYY_2t6j_mStop-900_mSo-100"					: {
			"CrossSection" : XSValues(XS_2016=0.0128895),
		},
	...
	def get_xs(self, name, year):
		...
		if not field in self.__values_dict[name]["CrossSection"]._fields:
			print self.__values_dict[name]["CrossSection"]
			raise KeyError("ERROR MCSampleValuesHelper::The CrossSectionValues tuple for process \"" + name + "\" does contain the key \"" + field + "\"")
		return self.__values_dict[name]["CrossSection"].__getattribute__(field)
