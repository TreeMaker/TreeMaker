...
def getWeightProducer(fileName):
    ...
    samples = [
        ...
        MCSample("ttHJetTobb_M125_13TeV_amcatnloFXFX_madspin_pythia8", "Asympt25ns_MCRUN2_74_V9_ext1-v1", "RunIISpring15DR74", "Constant", 0.290, 770921), # straight total = 2588639
