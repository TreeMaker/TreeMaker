...
def getWeightProducer(fileName,fastsim=False, pmssm=False):
    ...
    samples = [
        ...
        MCSample("step4_MINIAOD_mZprime-1000_mDark-20_rinv-0.3_alpha-0.2_n-1000", "ProductionV2", "", "Constant", 101734),
        MCSample("step4_MINIAOD_mZprime-3000_mDark-20_rinv-0.3_alpha-0.2_n-1000", "ProductionV2", "", "Constant", 50686),
        MCSample("step4_MINIAOD_mZprime-3000_mDark-20_rinv-0.3_alpha-0.1_n-1000", "ProductionV2", "", "Constant", 50485),
        MCSample("step4_MINIAOD_mZprime-3000_mDark-20_rinv-0.5_alpha-0.2_n-1000", "ProductionV2", "", "Constant", 50977),
        MCSample("step4_MINIAOD_mZprime-2000_mDark-20_rinv-0.3_alpha-0.2_n-1000", "ProductionV2", "", "Constant", 51109),
        MCSample("step4_MINIAOD_mZprime-4000_mDark-20_rinv-0.3_alpha-0.2_n-1000", "ProductionV2", "", "Constant", 50998),
        MCSample("step4_MINIAOD_mZprime-3000_mDark-1_rinv-0.3_alpha-0.2_n-1000", "ProductionV2", "", "Constant", 50700),
        MCSample("step4_MINIAOD_mZprime-3000_mDark-50_rinv-0.3_alpha-0.2_n-1000", "ProductionV2", "", "Constant", 51089),
        MCSample("step4_MINIAOD_mZprime-3000_mDark-100_rinv-0.3_alpha-0.2_n-1000", "ProductionV2", "", "Constant", 51000),
        MCSample("step4_MINIAOD_mZprime-3000_mDark-20_rinv-0.1_alpha-0.2_n-1000", "ProductionV2", "", "Constant", 52779),
        MCSample("step4_MINIAOD_mZprime-3000_mDark-20_rinv-0.7_alpha-0.2_n-1000", "ProductionV2", "", "Constant", 50733),
        MCSample("step4_MINIAOD_mZprime-3000_mDark-20_rinv-0.3_alpha-0.5_n-1000", "ProductionV2", "", "Constant", 51081),
        MCSample("step4_MINIAOD_mZprime-3000_mDark-20_rinv-0.3_alpha-1_n-1000", "ProductionV2", "", "Constant", 50904),
