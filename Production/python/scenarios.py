class Scenario:
    def __init__(self,sname):
        ...
        ### CURRENT
        if sname == "Spring16":
            self.set_vars("80X_mcRun2_asymptotic_2016_miniAODv2","PAT",True,False,False,"","data/jec/Spring16_25nsV3_MC",False,"data/jer/Fall15_25nsV2_MC","TreeMaker/Production/test/data/PileupHistograms_0621.root","Run2_25ns")
        elif sname == "Spring16sig":
            self.set_vars("80X_mcRun2_asymptotic_2016_miniAODv2","PAT",True,False,True,"","data/jec/Spring16_25nsV3_MC",False,"data/jer/Fall15_25nsV2_MC","TreeMaker/Production/test/data/PileupHistograms_0621.root","Run2_25ns")
        elif sname == "Spring16Fastsig":
            self.set_vars("80X_mcRun2_asymptotic_2016_miniAODv2","PAT",True,True,True,"","data/jec/Spring16_25nsV3_MC",False,"data/jer/Fall15_25nsV2_MC","TreeMaker/Production/test/data/PileupHistograms_0621.root","Run2_25ns")
        elif sname == "2016B":
