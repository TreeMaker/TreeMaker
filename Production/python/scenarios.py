class Scenario:
    def __init__(self,sname):
        ...
        if sname == "Spring16Fastsig":
            ...
            self.set_vars("80X_dataRun2_Prompt_v14","RECO",False,False,False,False,"data/Cert_271036-284044_13TeV_PromptReco_Collisions16_JSON.txt","data/jec/Summer16_23Sep2016AllV3_DATA",True,"","","Run2_25ns")
        elif sname == "2016ReReco23Sep":
            self.set_vars("80X_dataRun2_2016SeptRepro_v3","RECO",False,False,False,False,"data/Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16_JSON.txt","data/jec/Summer16_23Sep2016AllV3_DATA",True,"","","Run2_25ns")
