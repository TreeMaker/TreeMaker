class Scenario:
    def __init__(self,sname):
        ...
        if sname == "Phys14":
            ...
            self.set_vars("74X_mcRun2_asymptotic_v2","PAT",True,False,False,"","",False,"Run2_25ns")
        elif sname == "Spring15v2sig":
            self.set_vars("74X_mcRun2_asymptotic_v2","PAT",True,False,True,"","",False,"Run2_25ns")
            ...
            self.set_vars("74X_mcRun2_asymptotic_v2","PAT",True,True,True,"","",False,"Run2_25ns")
        elif sname == "2015B":
            ...
            self.set_vars("74X_dataRun2_Prompt_v1","RECO",False,False,False,"data/Cert_246908-258750_13TeV_PromptReco_Collisions15_25ns_JSON.txt","data/Summer15_25nsV5_DATA",True,"Run2_25ns")
        elif sname == "re2015C":
            self.set_vars("74X_dataRun2_v4","RECO",False,False,False,"data/Cert_246908-258750_13TeV_PromptReco_Collisions15_25ns_JSON.txt","",True,"Run2_25ns")
        elif sname == "2015D":
            self.set_vars("74X_dataRun2_Prompt_v1","RECO",False,False,False,"data/Cert_246908-258750_13TeV_PromptReco_Collisions15_25ns_JSON.txt","data/Summer15_25nsV5_DATA",True,"Run2_25ns")
        elif sname == "re2015D":
            self.set_vars("74X_dataRun2_reMiniAOD_v0","PAT",False,False,False,"data/Cert_246908-258750_13TeV_PromptReco_Collisions15_25ns_JSON.txt","",True,"Run2_25ns")
        elif sname == "2015Db":
            self.set_vars("74X_dataRun2_Prompt_v4","RECO",False,False,False,"data/Cert_246908-258750_13TeV_PromptReco_Collisions15_25ns_JSON.txt","",True,"Run2_25ns")
        else: #if no recognized scenario, set defaults
            self.known = False
            self.set_vars("74X_dataRun2_Prompt_v1","RECO",False,False,False,"","",False,"Run2_50ns")
