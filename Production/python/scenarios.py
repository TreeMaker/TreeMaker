class Scenario:
    def __init__(self,sname):
        ...
        if sname == "Summer16":
            self.set_vars("80X_mcRun2_asymptotic_2016_TrancheIV_v6","PAT",True,False,False,False,"","data/jec/Summer16_23Sep2016V2_MC",False,"data/jer/Spring16_25nsV6_MC","TreeMaker/Production/test/data/PileupHistograms_0721_63mb_pm5.root","Run2_25ns")
        if sname == "Summer16sig":
