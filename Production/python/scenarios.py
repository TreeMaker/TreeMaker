class Scenario:
    def __init__(self,sname):
        ...
        if sname == "Spring16":
            ...
            self.set_vars("80X_dataRun2_Prompt_v9","RECO",False,False,False,"data/Cert_271036-279588_13TeV_PromptReco_Collisions16_JSON_NoL1T.txt","data/jec/Spring16_25nsV6_DATA",True,"","","Run2_25ns")
        elif sname == "2016EF":
            self.set_vars("80X_dataRun2_Prompt_v10","RECO",False,False,False,"data/Cert_271036-279588_13TeV_PromptReco_Collisions16_JSON_NoL1T.txt","data/jec/Spring16_25nsV6_DATA",True,"","","Run2_25ns")
        elif sname == "2016G":
            self.set_vars("80X_dataRun2_Prompt_v11","RECO",False,False,False,"data/Cert_271036-279588_13TeV_PromptReco_Collisions16_JSON_NoL1T.txt","data/jec/Spring16_25nsV6_DATA",True,"","","Run2_25ns")
