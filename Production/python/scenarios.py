class Scenario:
    def __init__(self,sname):
        ...
        if sname == "Spring16":
            ...
            self.set_vars("80X_dataRun2_Prompt_v8","RECO",False,False,False,False,"data/Cert_271036-284044_13TeV_PromptReco_Collisions16_JSON.txt","data/jec/Spring16_25nsV6_DATA",True,"","","Run2_25ns")
        elif sname == "2016CD":
            self.set_vars("80X_dataRun2_Prompt_v9","RECO",False,False,False,False,"data/Cert_271036-284044_13TeV_PromptReco_Collisions16_JSON.txt","data/jec/Spring16_25nsV6_DATA",True,"","","Run2_25ns")
        elif sname == "2016EF":
            self.set_vars("80X_dataRun2_Prompt_v10","RECO",False,False,False,False,"data/Cert_271036-284044_13TeV_PromptReco_Collisions16_JSON.txt","data/jec/Spring16_25nsV6_DATA",True,"","","Run2_25ns")
        elif sname == "2016G":
            self.set_vars("80X_dataRun2_Prompt_v11","RECO",False,False,False,False,"data/Cert_271036-284044_13TeV_PromptReco_Collisions16_JSON.txt","data/jec/Spring16_25nsV6_DATA",True,"","","Run2_25ns")
        elif sname == "2016H":
            self.set_vars("80X_dataRun2_Prompt_v14","RECO",False,False,False,False,"data/Cert_271036-284044_13TeV_PromptReco_Collisions16_JSON.txt","data/jec/Spring16_25nsV6_DATA",False,"","","Run2_25ns")
        elif sname == "2016ReReco23Sep":
            self.set_vars("80X_dataRun2_2016SeptRepro_v3","RECO",False,False,False,False,"data/Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16_JSON.txt","data/jec/Spring16_25nsV6_DATA",False,"","","Run2_25ns")
