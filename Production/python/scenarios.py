class Scenario:
    def __init__(self,sname):
        ...
        if sname == "Spring15v2":
            ...
            self.set_vars("74X_dataRun2_reMiniAOD_v0","PAT",False,False,False,"data/Cert_246908-260627_13TeV_PromptReco_Collisions15_25ns_JSON_v2.txt","data/Summer15_25nsV6_DATA",True,"Run2_25ns")
        elif sname == "2015Db":
            self.set_vars("74X_dataRun2_Prompt_v4","RECO",False,False,False,"data/Cert_246908-260627_13TeV_PromptReco_Collisions15_25ns_JSON_v2.txt","data/Summer15_25nsV6_DATA",True,"Run2_25ns")
