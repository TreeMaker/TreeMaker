class Scenario:
    def __init__(self,sname):
        ...
        if sname == "Phys14":
            ...
            self.set_vars("74X_dataRun2_reMiniAOD_v0","PAT",False,False,"data/Cert_246908-258750_13TeV_PromptReco_Collisions15_25ns_JSON.txt","",True,"Run2_25ns")
        elif sname == "2015Db":
            self.set_vars("74X_dataRun2_Prompt_v4","RECO",False,False,"data/Cert_246908-258750_13TeV_PromptReco_Collisions15_25ns_JSON.txt","",True,"Run2_25ns")
