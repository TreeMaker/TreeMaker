...
python generateSubmission.py -n 1 -s -o $outputDir -c 2015B -f Run2015C-PromptReco-v1.DoubleEG
python generateSubmission.py -n 1 -s -o $outputDir -c 2015B -f Run2015C-PromptReco-v1.DoubleMuon
python generateSubmission.py -n 1 -s -o $outputDir -c 2015B -f Run2015C-PromptReco-v1.HTMHT
python generateSubmission.py -n 1 -s -o $outputDir -c 2015B -f Run2015C-PromptReco-v1.SingleElectron
python generateSubmission.py -n 1 -s -o $outputDir -c 2015B -f Run2015C-PromptReco-v1.SingleMuon
python generateSubmission.py -n 1 -s -o $outputDir -c 2015B -f Run2015C-PromptReco-v1.SinglePhoton
