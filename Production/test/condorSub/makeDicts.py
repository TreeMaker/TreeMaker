...
def main(args):
    ...
    parser.add_option("-e", "--era",           dest="era",      default='Fall17',                                                       help="The era used in the naming of the ouput dictionaries (default = %default)")
    parser.add_option("-l", "--location",      dest="location", default='Fall17/',                                                      help="Location of the file lists which will be added to the dictionary (default = %default)")
