...
mytests.append(makeTest("Spring15Fastv2","T1bbbbFast" if len(name)==0 else name,numevents,shell,dataset="/store/mc/RunIISpring15MiniAODv2/SMS-T1bbbb_mGluino-1000-1025_mLSP-1to975-1000_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/MINIAODSIM/FastAsympt25ns_74X_mcRun2_asymptotic_v2-v1/80000/00B3085A-7D7B-E511-A75B-003048335516.root"))
