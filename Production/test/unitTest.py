...
def defineTests(mytests, scenario, name, numevents, command, dataset, inputFilesConfig):
    ...
    mytests.append(Test("Summer20UL16sig","PrivateSamples.EMJ_2016_mMed-1000_mDark-20_kappa-0p25_aligned-down",numevents,"emerging=True doPhotons=True deepAK8=False deepDoubleB=False doZinv=False nestedVectors=False splitLevel=99"+command,inputFilesConfig="PrivateSamples.EMJ_2016_mMed-1000_mDark-20_kappa-0p25_aligned-down",nstart=0,nfiles=10))
    mytests.append(Test("Summer20UL16sig","PrivateSamples.EMJ_2016_mMed-1000_mDark-20_ctau-150_unflavored-down",numevents,"emerging=True doPhotons=True deepAK8=False deepDoubleB=False doZinv=False nestedVectors=False splitLevel=99"+command,inputFilesConfig="PrivateSamples.EMJ_2016_mMed-1000_mDark-20_ctau-150_unflavored-down",nstart=0,nfiles=10))
    mytests.append(Test("Summer20UL17sig","PrivateSamples.EMJ_2017_mMed-1000_mDark-20_kappa-0p25_aligned-down",numevents,"emerging=True doPhotons=True deepAK8=False deepDoubleB=False doZinv=False nestedVectors=False splitLevel=99"+command,inputFilesConfig="PrivateSamples.EMJ_2017_mMed-1000_mDark-20_kappa-0p25_aligned-down",nstart=0,nfiles=10))
    mytests.append(Test("Summer20UL17sig","PrivateSamples.EMJ_2017_mMed-1000_mDark-20_ctau-150_unflavored-down",numevents,"emerging=True doPhotons=True deepAK8=False deepDoubleB=False doZinv=False nestedVectors=False splitLevel=99"+command,inputFilesConfig="PrivateSamples.EMJ_2017_mMed-1000_mDark-20_ctau-150_unflavored-down",nstart=0,nfiles=10))
