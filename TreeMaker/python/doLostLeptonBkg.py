...
def doLostLeptonBkg(process,geninfo):
    ...
    process.TreeMaker2.VectorRecoCand.extend(['LeptonsNewTag:IdIsoMuon(selectedIDIsoMuonsNoMiniIso)','LeptonsNewTag:IdIsoElectron(selectedIDIsoElectronsNoMiniIso)','JetsProperties(Jets)'] )
