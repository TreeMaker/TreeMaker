...
class maker:
    def __init__(self,parameters):
        ...
        self.branchLists = [
            ...
            'VectorVectorBool','VectorVectorInt','VectorVectorVectorInt','VectorVectorDouble','VectorVectorString','VectorVectorLorentzVector','VectorVectorVectorLorentzVector','VectorVectorXYZVector','VectorVectorXYZPoint',
