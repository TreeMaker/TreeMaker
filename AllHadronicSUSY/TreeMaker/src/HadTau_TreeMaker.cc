// -*- C++ -*-
//
// Package:    AllHadronicSUSY/HadTau_TreeMaker
// Class:      HadTau_TreeMaker
// 
/**\class HadTau_TreeMaker HadTau_TreeMaker.cc AllHadronicSUSY/TreeMaker/plugins/HadTau_TreeMaker.cc
 * 
...
//
//
#include "AllHadronicSUSY/TreeMaker/interface/HadTau_TreeMaker.h"
...
//
HadTau_TreeMaker::HadTau_TreeMaker(const edm::ParameterSet& iConfig)
...
HadTau_TreeMaker::~HadTau_TreeMaker()
{
...
void
HadTau_TreeMaker::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
...
void 
HadTau_TreeMaker::endJob() {
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
HadTau_TreeMaker::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
void 
HadTau_TreeMaker::setBranchVariablesToDefault() 
{
...
std::pair <std::string,std::string> HadTau_TreeMaker::SeparateString(std::string InputStr, std::string Separater)
{
  std::string first="";
  std::string second="";
...
DEFINE_FWK_MODULE(HadTau_TreeMaker);

TString HadTau_TreeMaker::FinalizeName(std::string nameInTree)
{
  bool checkName=true;
