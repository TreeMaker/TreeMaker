...
InputFileName = "/afs/desy.de/user/a/adraeger/2015/TagAndProbe/elecTrack/TagAndProbeEff_ElecTrackIso.root"
...
InputTreeName = cms.string("TagAndProbeElecTrackIso"),
OutputFileName = cms.string("ElecTrackIsoMC_TagAndProbe.root"),
