// -*- C++ -*-
//
// Package:    AllJetsProducer
// Class:      AllJetsProducer
// 
/**\class AllJetsProducer AllJetsProducer.cc RA2Classic/AllJetsProducer/src/AllJetsProducer.cc
 * 
...
class AllJetsProducer : public edm::EDProducer {
public:
	explicit AllJetsProducer(const edm::ParameterSet&);
	~AllJetsProducer();
...
//
using namespace pat;
AllJetsProducer::AllJetsProducer(const edm::ParameterSet& iConfig)
{
        const std::string string1t("allJetFlag");
        const std::string string1("allJet");
...
AllJetsProducer::~AllJetsProducer()
{
...
void
AllJetsProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
...
void 
AllJetsProducer::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
AllJetsProducer::endJob() {
}

// ------------ method called when starting to processes a run  ------------
void 
AllJetsProducer::beginRun(edm::Run&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a run  ------------
void 
AllJetsProducer::endRun(edm::Run&, edm::EventSetup const&)
{
}

// ------------ method called when starting to processes a luminosity block  ------------
void 
AllJetsProducer::beginLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a luminosity block  ------------
void 
AllJetsProducer::endLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&)
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
AllJetsProducer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(AllJetsProducer);
