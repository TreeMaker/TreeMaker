...
LeptonProducer::LeptonProducer(const edm::ParameterSet& iConfig)
{
   ...
   produces<std::vector<float> >("MuIDMTW");
   produces<std::vector<float> >("MuIDIsoMTW");
   produces<std::vector<float> >("ElecIDMTW");
   produces<std::vector<float> >("ElecIDIsoMTW");
   produces<int>("");
   /* Examples
...
LeptonProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   ...
   std::auto_ptr<std::vector<float> > muIDMTW(new std::vector<float>());
   std::auto_ptr<std::vector<float> > muIDIsoMTW(new std::vector<float>());
   std::auto_ptr<std::vector<float> > elecIDMTW(new std::vector<float>());
   std::auto_ptr<std::vector<float> > elecIDIsoMTW(new std::vector<float>());
